import {
  l as decryptString,
  n as createSlotValueFromString,
  o as isAstroComponentFactory,
  ...
  t as ResponseSentError,
  v as ActionNotFoundError,
  M as MiddlewareNoDataOrNextCalled,
  w as MiddlewareNotAResponse,
  x as originPathnameSymbol,
  y as RewriteWithBodyUsed,
  G as GetStaticPathsRequired,
  I as InvalidGetStaticPathsReturn,
  z as InvalidGetStaticPathsEntry,
  B as GetStaticPathsExpectedParams,
  C as GetStaticPathsInvalidRouteParam,
  P as PageNumberParamNotFound,
  D as DEFAULT_404_COMPONENT,
  N as NoMatchingStaticPathFound,
  E as PrerenderDynamicEndpointPathCollide,
  H as ReservedSlotName,
  J as renderSlotToString,
  K as renderJSX,
  L as chunkToString,
  O as isRenderInstruction,
  Q as ForbiddenRewrite,
  S as SessionStorageInitError,
  T as SessionStorageSaveError,
  V as ASTRO_VERSION,
  W as CspNotEnabled,
  X as LocalsReassigned,
  Y as generateCspDigest,
  Z as PrerenderClientAddressNotAvailable,
  _ as clientAddressSymbol,
  $ as ClientAddressNotAvailable,
  a0 as StaticClientAddressNotAvailable,
  a1 as AstroResponseHeadersReassigned,
  a2 as responseSentSymbol$1,
  a3 as renderPage,
  a4 as REWRITE_DIRECTIVE_HEADER_KEY,
  a5 as REWRITE_DIRECTIVE_HEADER_VALUE,
  a6 as renderEndpoint,
  a7 as LocalsNotAnObject,
  a8 as REROUTABLE_STATUS_CODES,
  a9 as nodeRequestAbortControllerCleanupSymbol,
} from "./astro/server_CZjIeNvH.mjs";
...
import {
  ...
  e as ensure404Route,
} from "./astro-designed-error-pages_ZmIT0fNe.mjs";
...
class App {
  ...
  static validateForwardedHeaders(
    ...
    if (forwardedPort && allowedDomains && allowedDomains.length > 0) {
      const hasPortPatterns = allowedDomains.some(
        (pattern) => pattern.port !== void 0,
      );
      if (hasPortPatterns) {
        const isAllowed = allowedDomains.some(
          (pattern) => pattern.port === forwardedPort,
        );
        if (isAllowed) {
    ...
    if (
      ...
      if (sanitized) {
        try {
          ...
          const portFromHost = sanitized.includes(":")
            ? sanitized.split(":")[1]
            : void 0;
...
new RegExp(builtinModules.map((mod) => `(^${mod}$|^node:${mod}$)`).join("|"));
